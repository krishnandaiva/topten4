...
class Mirasvit_MCore_Model_Image extends Mage_Core_Model_Abstract
{
    protected $_width;
	protected $_height;
	...
	public function setBaseFile($file)
	{
		...
		$baseDir = Mage::getSingleton('mcore/media_config')->getBaseMediaPath();
		...
		$path = array(Mage::getSingleton('mcore/media_config')->getBaseMediaPath(), 'cache', 'images', Mage::app()->getStore()->getId());
	...
	public function getUrl()
	{
		...
		return Mage::getSingleton('mcore/media_config')->getBaseMediaUrl() . '/' . str_replace(DS, '/', $path);
	}
	...
	{
		$directory = Mage::getSingleton('mcore/media_config')->getBaseMediaPath() . DS . 'content' . DS . 'cache' . DS;
